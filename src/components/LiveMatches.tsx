...
export const LiveMatches = () => {
    ...
    return (
      <Card>
        <CardContent className="p-6 text-center">
          ...
          <p className="text-destructive">Erro ao carregar jogos ao vivo</p>
        </CardContent>
      </Card>
    );
  }
      ...
      <Card>
        <CardContent className="p-8 text-center">
          ...
          <p className="text-muted-foreground">
            Não há jogos acontecendo no momento. Verifique a aba Pré-Live para próximos jogos.
          </p>
        </CardContent>
      </Card>
    );
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h3 className="text-xl font-semibold">Jogos ao Vivo</h3>
          <p className="text-sm text-muted-foreground">
            {liveMatches.length} jogo(s) em andamento
          </p>
        </div>
